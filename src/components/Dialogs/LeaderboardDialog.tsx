...
const LeaderboardDialog = () => {
  return (
    <Dialog>
      ...
      <DialogOverlay className="w-screen h-screen overflow-y-auto bg-white md:p-10 p-5">
        <DialogClose asChild>
        ...
        <div className="w-full lg:w-1/2 h-full flex flex-col gap-5  mx-auto">
          ...
          <div className="w-full flex-1 mx-auto md:p-5 p-3 md:rounded-2xl rounded-lg bg-teal-500/10 grid md:grid-rows-5 md:grid-cols-2 md:gap-5 gap-2">
