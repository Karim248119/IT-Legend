  ...
  return (
    <Dialog>
      ...
      <DialogOverlay className="w-screen h-screen bg-white md:p-10 p-5">
        <DialogClose asChild>
          <button className="absolute top-5 right-5 md:w-8 w-6 aspect-square flex items-center justify-center rounded-lg hover:bg-teal-500 hover:text-white border border-teal-500 duration-300">
            <X className="w-4 md:w-6" />
          </button>
        </DialogClose>
        <div className="w-full lg:w-1/2 h-full flex flex-col md:gap-5 gap-5">
          <Header size="lg" className="mx-auto text-teal-800">
            Leaderboard
          </Header>
          <div
            dir="rtl"
